...
namespace MKDD.Patcher.IO
{
    ...
    {
        public static Endianness NativeEndianness { get; } = BitConverter.IsLittleEndian ? Endianness.Little : Endianness.Big;
        ...
        {
            var integer = Swap( Unsafe.As<float, uint>( ref value ) );
            return Unsafe.As<uint, float>( ref integer );
        }
        ...
        {
            var integer = Swap( Unsafe.As<double, ulong>( ref value ) );
            return Unsafe.As<ulong, double>( ref integer );
        }
